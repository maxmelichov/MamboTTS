...
import mambottsLogo from "../assets/mambotts-mark.png";
...
export function Brand({ className }: { className?: string }) {
  return (
    ...
    >
      <img src={mambottsLogo} alt="" className="h-5 w-5 shrink-0" />
      <span>MamboTTS</span>
    </div>
  );
}
...
export function LogoMark({ className }: { className?: string }) {
  return <img src={mambottsLogo} alt="" className={cn("shrink-0", className)} />;
}
